      ...
      <div className="container-wide relative z-10 pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/20 text-accent mb-8 animate-fade-in-up">
            ...
            <span className="text-sm font-medium">UK's First Smart Compliance Solution</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-primary-foreground/70 mb-8 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
            We resolve issues before they become a problem. InsightResolve is the UK's first smart, 
            compliance-driven complaint handling service — powered by our proprietary CompliFlow intelligence engine.
          </p>
